...
<head>
	...
	<link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/bootstrap-redesign.css?901e5ea"/>
	<link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/font-awesome.min.css?901e5ea"/>
...
<div class="container-fluid">
    ...
    ?>
    <div id="header">
		<div class="pull-right" id="header-info">
			<p><?php echo sprintf(__('Welcome, %s.'), '<strong>'.$thisstaff->getFirstName().'</strong>'); ?>
			   <?php
